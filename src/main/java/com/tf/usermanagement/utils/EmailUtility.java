...
public class EmailUtility {
	...
	public void sendMailToUser(String userEmail,String userName, String userPassword) {
		try {
			Email email = new Email();
			email.setToAddress(userEmail);
			email.setEmailSubject(environment.getProperty("registration.successsubject"));

			email.setMessage(environment.getProperty("registration.successmsg")+ " <br> " + " UserName : " + userName + "<br>" + "UserPassword : " + userPassword);
